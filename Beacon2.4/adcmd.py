...
class install:
    def check_type(filename: str | None = ...) -> bool:
        if filename[-1][1:] == "pyc":
            return True
        else:
            return False

    def check_exists(pkg_name: str | None = ...) -> bool:
    ...
    def install(name: str | None = ...) -> None | bool:
        try:
    ...
    def refresh(target: str | None = ..., flag: str | None = ...) -> bool:
        raise REFRESH
